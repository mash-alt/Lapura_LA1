namespace Lapura_LA1
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            Submit.Location = new Point(201, 232);
            Submit.Name = "Submit";
            ...
            LastName.Location = new Point(331, 169);
            ...
            FirstName.Location = new Point(331, 109);
            ...
            label2.Location = new Point(201, 172);
            label2.Name = "label2";
            ...
            label1.Location = new Point(201, 112);
            label1.Name = "label1";
            ...
            // Next
            // 
            Next.BackColor = Color.FromArgb(0, 32, 63);
            Next.Cursor = Cursors.Hand;
            Next.FlatAppearance.BorderSize = 0;
            Next.FlatStyle = FlatStyle.Flat;
            Next.Font = new Font("Segoe UI Semibold", 10F, FontStyle.Bold);
            Next.ForeColor = Color.White;
            Next.Location = new Point(431, 232);
            Next.Name = "Next";
            Next.Size = new Size(150, 45);
            Next.TabIndex = 6;
            Next.Text = "Next";
